...
class RPRDataset(DetectFeatTxtTokDataset):
    ...
    def __getitem__(self, i):
        ...
        return input_ids, img_feat, img_pos_feat, attn_masks, txt_labels,im_fname,example['target']
...
def rpr_collate(inputs):
    ...
    (input_ids, img_feats, img_pos_feats, attn_masks, txt_labels,im_fnames,targets
