...
def parse_args():
    ...
    #our options
    parser.add_argument('--dec', type=int, choices=[0,1])
    parser.add_argument('--model', type=str, required=True,choices=['base','nlvr','vqa'])
    parser.add_argument('--data', type=str,choices=['coco','flickr','flowers'])
    parser.add_argument('--task', type=str,choices=['position','color','size'])
