...
def get_nbobj(fname,id2nb,args):
    if args.data == "coco":
        ...
        return id2nb[int(get_id("c0"+fname+".npz"))]
    if args.data == "flowers":
        return 1
    else :
...
class LXMERT:
    ...
    def get_representation(self,eval_tuple: DataTuple,id2nb):
        ...
        polled ,visual ,lang, fnames ,texts,input_idss,segment_idss,input_masks, nbobj= [],[],[],[],[],[],[],[],[]
        ...
        # language Inputs
                ...
                if args.dec == 1 and args.data=='flickr':
                ...
                nbobj.append(get_nbobj(fname,id2nb,args))
        ...
        repre = {"fnames":fnames , "texts":texts ,'visual':visual,'pooled_representation':polled,"lang":lang,
                "input_ids":input_idss,"nbobj":nbobj}
        filename = "../representations/lxmert_"+args.model+"_"+args.data+".pickle" if args.dec==0 else "../representations/lxmert_"+args.model+"_"+args.data+"_dec.pickle"
