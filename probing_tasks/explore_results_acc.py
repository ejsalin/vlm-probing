...
if __name__ == "__main__":
    ...
    with open(args.output+'/results.txt', 'w') as f:
        ...
        for model in means.keys():
            ...
            print('acc')
            print('lin : ',mean[model]['train_lin_acc']+" last :"+mean_last[model]['train_lin_acc']+"  epoch : "+mean_idx[model]['train_lin_acc'])
            ...
            print('acc')
            print('lin : ',mean[model]['val_lin_acc']+" last :"+mean_last[model]['val_lin_acc']+"  epoch : "+mean_idx[model]['val_lin_acc'])
