...
def main(args):
  ...
  # LXMERT DATA
    ...
    c = Counter([x[1] for x in lxmert_words_val])
    print(len(c))
    print([(i, c[i] / len(lxmert_words_val) * 100.0) for i, count in c.most_common(10)])
    ...
    if MODELS:
        ...
        print(Counter([x[1] for x in bert_words_val]))
    ...
    print(Counter([x[1] for x in uniter_words_val]))
